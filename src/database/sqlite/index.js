...
const path = require('path')
  /* path --- library nativa do Node; serve pra resolver compatibilidade dos endereços de arquivo, 
              de acordo com o ambiente (windows, mac, linux, etc) */
...
async function sqliteConnection() {
  ...
  const database = await sqlite.open({
    ...
    /* open() --- Method pra abrir uma conexão
       ...
       driver --- escolhe quem vai ser o driver principal 
                  (geralmente, é "sqlite3" com a class ".Database") */
