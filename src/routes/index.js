/* index --- esse arquivo serve somente pra unir todas as rotas da aplicação; 
             faz parte do contexto do arquivo "routes (2º/5)" */


const { Router } = require('express')
  // Router --- permite separar cada rota (ou grupo de rotas relacionadas) em um arquivo específico
...
routes.use('/users', usersRouter)
  /* use('/x', y) --- Method que indica a rota
                  '/x' --- endereço da rota
                     y --- (request, response); nesse caso, foi substituído direto pelo "usersRouter", 
